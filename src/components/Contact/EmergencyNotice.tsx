...
const EmergencyNotice: React.FC = () => (
  ...
  >
    <div role="alert" className="flex items-start gap-3">
      <AlertTriangle
        aria-hidden="true"
        className="shrink-0 mt-1 text-red-500 dark:text-red-400"
        size={22}
      />
      <div>
        ...
        <p className="text-slate-600 dark:text-slate-300 text-sm lg:text-base">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 font-semibold hover:underline focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 rounded-sm"
          >
