  ...
  const networks = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path d="M12.83 11.17a1 1 0 0 0-1.66 0l-1.26 2.1a1 1 0 0 0 .83 1.53h2.52a1 1 0 0 0 .83-1.53l-1.26-2.1z" />
          <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12a9.96 9.96 0 0 0 6.33 9.12" />
        </svg>
      ),
    ...
    <div className="mt-4 flex items-center justify-center gap-2">
      ...
      {networks.map((network) => (
        <a
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 transition-colors hover:bg-slate-300 dark:bg-slate-700 dark:hover:bg-slate-600"
