...
const HeroContent = () => {
  return (
    <section className="mt-40 max-w-3xl md:max-w-4xl">
      <TypographyH1 className="ty-auto text-5xl/10 leading-tight font-bold text-white md:text-5xl lg:text-6xl dark:text-white">
        Your Trusted <span className="text-blue-600">Plumbing Experts</span> in Manhattan
      </TypographyH1>
      <TypographyP className="text-md mt-5 mb-5 leading-relaxed text-white/90 md:text-lg lg:text-xl">
