...
const PaginationButton: React.FC<PaginationButtonProps> = ({
  ...
  const variantStyles = isActive
    ...
    : 'border border-slate-300 dark:border-slate-600 bg-transparent hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 text-slate-800 dark:text-white focus:ring-blue-500'
