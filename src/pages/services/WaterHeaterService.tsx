...
const WaterHeatersServicePage = () => {
  ...
  const tankInstallation =
    "https://images.pexels.com/photos/4239013/pexels-photo-4239013.jpeg";
  const tanklessSystem =
    "https://images.pexels.com/photos/5691636/pexels-photo-5691636.jpeg";
  const repairService =
    "https://images.pexels.com/photos/5691635/pexels-photo-5691635.jpeg";
  const maintenanceImage =
    "https://images.pexels.com/photos/4108795/pexels-photo-4108795.jpeg";
        ...
        <div className="container mx-auto px-4 md:px-6 py-32 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Reliable hot water solutions with 24/7 emergency service and
              10-year guarantees
            </p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Save Up To 34% On Energy Bills
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
            Modern tankless water heaters can significantly reduce your energy
            consumption. Ask about our special rebates and financing options.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              href="tel:+12125551234"
