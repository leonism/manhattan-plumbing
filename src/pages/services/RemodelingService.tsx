      ...
      try {
        const response = await fetch(
          "https://api.pexels.com/v1/search?query=luxury+bathroom+remodel&per_page=6",
          {
            headers: {
              Authorization:
                "5bXehp9eT0tv7vpIsJCgLsRK5cKOm5liuVdUphgYKfeJco8Hv2cE1h14", // Replace with your actual API key
            },
          }
        );
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            {[
              ...
              },
              {
                ...
                description:
                  "Access to premium brands and materials at competitive prices.",
              },
            ].map((feature, index) => (
              <div
                key={index}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-12">
            {[
              ...
              },
              {
                ...
                description:
                  "Professional craftsmanship with premium materials",
                icon: (
                  <Hammer
                    size={32}
                    className="text-blue-600 dark:text-blue-400"
