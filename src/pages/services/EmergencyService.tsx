        ...
        <div className="container mx-auto px-4 md:px-6 py-32 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-red-100 mb-8">
              Immediate response to prevent water damage and restore your
              plumbing
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            {[
              ...
              },
              {
                ...
                description:
                  "Our team is standing by 365 days a year, including holidays.",
              },
              {
                icon: (
                  <Wrench
                ...
                description:
                  "Licensed master plumbers with 10+ years emergency experience.",
              },
            ].map((feature, index) => (
              <div
                key={index}
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-xl text-red-100 max-w-3xl mx-auto mb-8">
            Every minute counts when dealing with water or gas emergencies. Our
