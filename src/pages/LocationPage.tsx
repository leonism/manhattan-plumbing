...
const LocationPage: React.FC = () => {
  const jsonLd = {
    ...
    url: 'https://www.manhattanplumbing.com/location',
    image: 'https://www.manhattanplumbing.com/manhattan-plumber.png',
    priceRange: '$',
            ...
            {[
              {
                ...
                description:
                  'Meet our certified plumbers for personalized advice and solutions.',
              },
              {
            ...
            {[
              {
                ...
                content: (
                  <div className="aspect-w-16 aspect-h-9 overflow-hidden rounded-lg shadow-lg">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d96708.35377212726!2d-74.0516318508202!3d40.75903219750165!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2588f046ee661%3A0xa0b3281fcecc08c!2sManhattan%2C%20New%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sid!4v1752327321331!5m2!1sen!2sid" width="100%" height="450" style={{ border: 0 }} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Manhattan Plumbing Location"></iframe>
                  </div>
                ),
                features: [
      ...
      <section className="bg-linear-to-r from-blue-600 to-blue-800 py-16 text-white">
        <div className="container mx-auto px-4 text-center md:px-6">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Button href="https://www.google.com/maps/dir/?api=1&destination=Manhattan+Plumbing,+New+York,+NY" target="_blank" rel="noopener noreferrer" variant="secondary">
              <div className="flex items-center">
